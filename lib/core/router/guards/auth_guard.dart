...
/// Desacoplado de infraestructura: consulta el estado a través de [AuthCubit].
class AuthGuard {
  final AuthCubit authCubit;

  const AuthGuard({required this.authCubit});
  ...
  String? redirect(BuildContext context, GoRouterState state) {
    final bool isAuthenticated = authCubit.isAuthenticated;
