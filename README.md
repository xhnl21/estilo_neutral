...
2. Agrega los **Scopes requeridos**:
   - `https://www.googleapis.com/auth/spreadsheets` *(Lectura y escritura de la hoja)*
   - `https://www.googleapis.com/auth/drive.readonly` *(Lectura de metadatos y fotos de productos en Drive)*
