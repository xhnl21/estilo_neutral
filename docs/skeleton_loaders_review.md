...
| **Ventas**                | `lib/presentation/pages/ventas_page.dart` (nota: reescrita en 2026-09 con esquema de factura multi-ítem, ver [Casos de Uso — UC-30](casos-de-uso.md#uc-30-registrar-una-venta-factura-con-uno-o-mas-productos); la ruta original era `lib/features/sales/presentation/pages/sales_page.dart`, ya eliminada) | `SalesSkeleton`            | Simula métricas KPI consolidadas (Facturación Total y Deuda Pendiente), barra de filtros por chips y listado de transacciones con montos.       |
